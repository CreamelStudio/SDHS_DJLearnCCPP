...
int OnCreate(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
	...
	//OnCreate(hWand,NLII,NULL); //안 좋은 번삭
	return 0;  
}
...
int OnPaint(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
	...
	wsprintf(strTime,L"%d시 %d분 %d초",gSt.wHour,gSt.wMinute,gSt.wSecond); //문자열에 시간 저장
	TextOut(hdc, 0, 0, strTime,wcslen(strTime));//윈도우에 글자 출력
